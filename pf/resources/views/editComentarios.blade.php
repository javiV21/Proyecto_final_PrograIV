...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        textarea {
            resize: vertical;
            min-height: 120px; /* Adjusted min-height for textarea to fit typical comment length */
        }
...
<body>
    ...
    <main>
        <section class="form-container" aria-labelledby="edit-comment-title">
            <h1 id="edit-comment-title">Editar Comentario</h1>
            ...
            <form action="{{ route('comentarios.update', $comentario) }}" method="POST" novalidate>
                ...
                <div class="form-group">
                    ...
                    <textarea id="contenido" name="contenido" required aria-required="true">{{ old('contenido', $comentario->contenido) }}</textarea>
                    @error('contenido')
